            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="<?php echo get_template_directory_uri(); ?>/img/header.jpg" alt="Image">
                    ...
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        ...
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="detail.html">
                            ...
                            <div class="courses-text">
                                <h4 class="text-center text-white px-3"><?php echo get_sub_field('h1'); ?></h4>
                                <div class="border-top w-100 mt-3">
                                    <div class="d-flex justify-content-between p-4">
                                        <span class="text-white"><i class="fa <?php echo get_sub_field('icon1'); ?> mr-2"></i><?php echo get_sub_field('heading1'); ?></span>
                                        <span class="text-white"><i class="fa <?php echo get_sub_field('icon2'); ?> mr-2"></i><?php echo get_sub_field('heading2'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="mb-5">
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="">
                            <img class="img-fluid rounded" src="<?php echo get_template_directory_uri(); ?>/img/courses-80x80.jpg" alt="">
                            <div class="pl-3">
